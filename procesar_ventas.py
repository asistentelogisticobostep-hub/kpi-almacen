...
# texto legible solo para una tabla puntual en Looker, se resuelve ahí con un campo
# calculado (CASE WHEN OBSERVACIONES = "" THEN "Sin observaciones" ELSE OBSERVACIONES
# END), no reescribiendo la fuente para todos los demás gráficos.
